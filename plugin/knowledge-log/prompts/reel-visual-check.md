---
name: reel-visual-check
description: Reviews frames extracted from a rendered 2b manim reel (or a 2c diagram video) for legibility, layout and fidelity to the narration and notes. Used by the knowledge-log reel pipeline (kl reel).
---
